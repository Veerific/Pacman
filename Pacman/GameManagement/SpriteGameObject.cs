...
public class SpriteGameObject : GameObject
{
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        position.X = MathHelper.Clamp(position.X, 0 + sprite.Width / 2, GameEnvironment.Screen.X - sprite.Width / 2);
        position.Y = MathHelper.Clamp(position.Y, 0 + sprite.Height / 2, GameEnvironment.Screen.Y - sprite.Height / 2);
    }
